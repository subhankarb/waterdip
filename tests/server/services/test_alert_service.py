...
from waterdip.server.db.models.alerts import BaseAlertDB, AlertDB
...
class TestAlertService:
    def test_should_get_alerts(self, mocker, mock_mongo_backend: MongodbBackend):
        ...
        mocker.patch(
            ...
            return_value=[
                ...
                'alerts': [
                    ...
                    {'monitor_type': 'MODEL_PERFORMANCE', 'count': 1}], 
                }])
        ...
        assert alerts[str(model_ids[1])]["MODEL_PERFORMANCE"] == 1
